...
//	    int content_id=Integer.parseInt(id);
    ...
    public Boolean add_to_app_contents(String id, String title, String body, String sname, String cname, String catid, String sectionid, String state, String sabk, String poet_id, String poet_name, String is_visited) {
